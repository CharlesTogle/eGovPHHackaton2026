...
export async function askAiAssistant(
  ...
  try {
    ...
    } else if (lower.includes("earthquake") || lower.includes("quake") || lower.includes("tremor") || lower.includes("shake")) {
      contextualAnswer = `Post-Earthquake Safety & Disaster Procedure Guidelines:\n\n1. **Drop, Cover, & Hold On**: Expect aftershocks. Protect your head and remain under sturdy cover during secondary tremors.\n2. **Inspect Household Hazards**: Check for structural wall cracks, gas leaks, damaged wiring, and water leaks. Turn off gas/main switches if damage is detected.\n3. **Evacuate Safely**: Walk carefully to designated open spaces away from tall structures, posts, and unstable slopes.\n4. **Coastal Tsunami Warning**: If located near coastal zones, evacuate to high ground immediately.\n5. **Log HANDA Check-in**: Submit your status and specific needs (Shelter, Medical, Water) inside HANDA so Barangay responders can dispatch emergency assistance.\n6. **Emergency Call**: Call **911** for urgent medical rescue or Red Cross at **143**.`
